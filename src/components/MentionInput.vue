...
onMounted(() => {
  ...
  // 設置初始內容
  if (modelValue.value && inputContainer.value) {
    inputContainer.value.textContent = modelValue.value
  }
})
